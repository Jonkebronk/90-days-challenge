...
async function main() {
  console.log('🏋️ Starting "Andra fasen - fokus underkropp" workout program seed...');
  ...
  // All exercises should already exist from first phase
  ...
  for (const name of exerciseNames) {
    if (!exercises[name]) {
      ...
      if (!exercise) {
        ...
        throw new Error(`Exercise "${name}" not found. Please run the first phase seed first.`);
      }
  ...
  const workoutProgram = await prisma.workoutProgram.create({
    data: {
      coachId: coach.id,
      name: 'Andra fasen - fokus underkropp',
      description: 'Ett 5-dagars träningsprogram med fokus på underkropp och core. Progression från första fasen med högre intensitet: 4-5 set, 9-12 reps, 60s vila.',
          ...
          // Pass 1: Rygg + Biceps
          {
            ...
            exercises: {
              create: [
                ...
                { exerciseId: exercises['Stångrodd'], sets: 4, repsMin: 9, repsMax: 12, restSeconds: 60, orderIndex: 1 },
                ...
                { exerciseId: exercises['Hammercurl'], sets: 5, repsMin: 9, repsMax: 12, restSeconds: 60, orderIndex: 5 },
              ],
            },
          },
          // Pass 2: Framsida lår + rumpa
          {
            ...
            exercises: {
              create: [
                ...
                { exerciseId: exercises['Hipthrust med stång'], sets: 4, repsMin: 9, repsMax: 12, restSeconds: 60, orderIndex: 3 },
          ...
          // Pass 3: Axlar, bröst + triceps
          {
            ...
            exercises: {
              create: [
                ...
                { exerciseId: exercises['Omvänd pecdec'], sets: 4, repsMin: 9, repsMax: 12, restSeconds: 60, orderIndex: 4 },
                { exerciseId: exercises['Extensioner med rep över huvud'], sets: 5, repsMin: 9, repsMax: 12, restSeconds: 60, orderIndex: 5 },
          ...
          // Pass 4: Baksida lår + rumpa
          {
            ...
            exercises: {
              create: [
                ...
                { exerciseId: exercises['Rumänska marklyft med hantlar'], sets: 4, repsMin: 9, repsMax: 12, restSeconds: 60, orderIndex: 1 },
                { exerciseId: exercises['Sittande lårcurl'], sets: 4, repsMin: 9, repsMax: 12, restSeconds: 60, orderIndex: 2 },
                { exerciseId: exercises['Hipthrust i maskin'], sets: 4, repsMin: 9, repsMax: 12, restSeconds: 60, notes: 'Dropset på sista setet', orderIndex: 3 },
  ...
  console.log('  - Sets: 4-5 (högre volym än första fasen)');
