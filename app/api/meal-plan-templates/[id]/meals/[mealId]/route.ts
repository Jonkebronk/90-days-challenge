  ...
  try {
    ...
    const meal = await prisma.templateMeal.update({
      ...
      data: {
        ...
        carbSource: body.carbSource !== undefined ? (body.carbSource || null) : undefined,
        proteinSource: body.proteinSource !== undefined ? (body.proteinSource || null) : undefined,
        fatSource: body.fatSource !== undefined ? (body.fatSource || null) : undefined,
