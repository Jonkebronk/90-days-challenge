...
const navigation = [
  ...
  { name: 'Intresseanmälningar', href: '/dashboard/leads', icon: UserPlus, coachOnly: true },
  {
    ...
    dropdown: [
      ...
      { name: 'Kostschema Generator', href: '/dashboard/content/kostschema-generator', icon: Scale },
      ...
      { name: 'Träningscykler', href: '/dashboard/content/training-cycles', icon: Layers },
  ...
  { name: 'Matlogg', href: '/dashboard/food-log', icon: ClipboardList, clientOnly: true },
  { name: 'Produktbibliotek', href: '/dashboard/products', icon: ShoppingCart, clientOnly: true },
