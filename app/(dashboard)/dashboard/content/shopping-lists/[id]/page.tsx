    ...
    <div className="container mx-auto p-6 space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              {list.description && (
                <p className="text-[rgba(255,255,255,0.6)] mt-1">{list.description}</p>
              )}
            </div>
          </div>
        </div>
      ...
      <Card className="bg-[rgba(255,255,255,0.03)] border-2 border-[rgba(255,215,0,0.2)] backdrop-blur-[10px]">
        <CardContent className="p-4">
          <div className="flex items-center justify-between mb-2">
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                disabled={!canEdit}
                className="bg-transparent border border-[rgba(255,215,0,0.3)] text-[rgba(255,255,255,0.8)] hover:bg-[rgba(255,215,0,0.1)] hover:text-[#FFD700] disabled:opacity-50"
              >
              ...
              <Button
                ...
                className="bg-transparent border border-[rgba(255,0,0,0.3)] text-[rgba(255,255,255,0.8)] hover:bg-[rgba(255,0,0,0.1)] hover:text-red-400 disabled:opacity-50"
              >
          ...
          <div className="w-full bg-[rgba(0,0,0,0.3)] rounded-full h-2">
            <div
        ...
        <div className="lg:col-span-1 space-y-4">
          {canEdit && (
            <>
              ...
              <Card className="bg-[rgba(255,255,255,0.03)] border-2 border-[rgba(255,215,0,0.2)] backdrop-blur-[10px]">
                <CardHeader>
                  <CardTitle className="text-lg font-bold text-[#FFD700] tracking-[1px]">
                ...
                <CardContent className="space-y-3">
                  ...
                  {isSearching && (
                    <p className="text-sm text-[rgba(255,255,255,0.6)]">Söker...</p>
                  )}
                  {searchResults.length > 0 && (
                    <div className="space-y-2 max-h-80 overflow-y-auto">
                      {searchResults.map((item) => (
                        <div
                          key={item.id}
                          className="flex items-center justify-between p-2 bg-[rgba(0,0,0,0.2)] rounded hover:bg-[rgba(255,215,0,0.1)] transition-colors"
                        >
                          <div>
              ...
              <Card className="bg-[rgba(255,255,255,0.03)] border-2 border-[rgba(255,215,0,0.2)] backdrop-blur-[10px]">
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <div>
                      <Label className="text-[rgba(255,255,255,0.8)]">Antal</Label>
                      <Input
                        type="number"
                        step="0.1"
                    ...
                    <div>
                      <Label className="text-[rgba(255,255,255,0.8)]">Enhet</Label>
                      <Input
            ...
            <CardContent>
              {totalItems === 0 ? (
                <div className="text-center py-12">
                  <p className="text-[rgba(255,255,255,0.6)]">Inga varor ännu.</p>
                            ...
                            <div
                              ...
                              className={`flex items-center gap-3 p-3 rounded-lg border transition-all ${
                                item.checked
                                  ...
                                  : 'bg-[rgba(0,0,0,0.2)] border-[rgba(255,215,0,0.1)]'
                              }`}
                            >
                              <Button
                                variant="ghost"
                                ...
                                disabled={!canEdit}
                                className="flex-shrink-0 hover:bg-[rgba(255,215,0,0.1)]"
                              >
                                {item.checked ? (
                              ...
                              {canEdit && (
                                <Button
                                  ...
                                  className="flex-shrink-0 text-[rgba(255,255,255,0.6)] hover:text-red-400 hover:bg-[rgba(255,0,0,0.1)]"
                                >
      ...
      <Dialog open={isShareDialogOpen} onOpenChange={setIsShareDialogOpen}>
        <DialogContent className="bg-[rgba(10,10,10,0.95)] border-2 border-[rgba(255,215,0,0.3)] backdrop-blur-[10px] max-w-md">
          ...
          <div className="space-y-4">
            <div>
              <Label className="text-[rgba(255,255,255,0.8)]">Användar-ID</Label>
              <Input
                value={shareUserId}
            ...
            <div>
              <Label className="text-[rgba(255,255,255,0.8)]">Behörighet</Label>
