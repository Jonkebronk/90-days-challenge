...
async function main() {
  console.log('🥧 Creating Bärpaj recipe...\n')
  ...
  const recipe = await prisma.recipe.create({
    data: {
      title: 'Bärpaj',
      description: 'Supergod frukostpaj som påminner lite om en knäckig smulpaj.',
      categoryId: category.id,
      servings: 1,
      coverImage: 'https://i.postimg.cc/7hqYDWqN/2025-11-14-12-13-48-NVIDIA-Ge-Force-Overlay-DT.png',
      ...
      instructions: {
        create: [
          ...
          {
            stepNumber: 2,
            instruction: 'Blanda havregryn med ägg, kanel och kardemumma',
          },
          {
            stepNumber: 3,
            instruction: 'Lägg frysta hallon & blåbär i botten på en form. 12cm i diameter funkar toppen för 1 portion :)',
          },
          {
            stepNumber: 4,
            instruction: 'Klicka ut havregrysblandningen i formen och bre ut jämnt över bären',
          },
          {
            stepNumber: 5,
            instruction: 'Ställ in formen i ugnen 15 min alt. tills den fått fin färg',
          },
          {
            stepNumber: 6,
            instruction: 'Låt svalna några minuter och servera med Vaniljkvarg :)',
          },
        ],
      },
    },
