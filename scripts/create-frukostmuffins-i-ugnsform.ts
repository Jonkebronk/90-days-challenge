...
async function main() {
  ...
  const recipe = await prisma.recipe.create({
    data: {
      ...
      description: 'Perfekt frukost för dig som är i farten och vill sova lite längre på morgonen!',
      categoryId: category.id,
      servings: 1,
      coverImage: 'https://i.postimg.cc/4yRHcPs3/2025-11-14-12-12-23-NVIDIA-Ge-Force-Overlay-DT.png',
      ...
      instructions: {
        create: [
          {
            stepNumber: 1,
            instruction: 'Sätt ugnen på 200Â°',
          },
          {
            stepNumber: 2,
          ...
          {
            stepNumber: 3,
            instruction: 'Häll över den tjocka smeten i en ugnssakar form, tex IKEAs glasmatlådor',
          },
          {
            stepNumber: 4,
            instruction: 'Grädda i mitten av ugnen i ca 30min',
          },
          {
            stepNumber: 5,
            instruction: 'Ät varm, kall eller dagen efter!',
          },
        ],
      },
    },
