...
async function main() {
  console.log('🥖 Lägger till recept: Knäckebröd med keso...')
  ...
  try {
    ...
    const recipe = await prisma.recipe.create({
      data: {
        ...
        description: 'Enkel och proteinrik frukost med knäckebröd, laktosfri keso och mandlar alternativt avokado.',
    ...
    const ingredients = [
      ...
      { name: 'Knäckebröd Husman Wasa', amount: '2', unit: 'skivor', grams: 26 },
    ...
    const instructions = [
      'Fördela keso på rågbrödet eller knäckebrödet och käka mandlarna på sidan om alternativt avokado på brödet.',
    ]
    ...
    console.log('\n🎉 Recept "Knäckebröd med keso" har skapats!')
