          ...
          <table className="w-full">
            <thead>
              <tr className="bg-[rgba(74,103,65,0.3)] border-b-2 border-[rgba(255,215,0,0.2)]">
                <th className="px-4 py-3 text-left text-sm font-medium text-[rgba(255,255,255,0.9)]">
                  Ingrediens
                </th>
                <th className="px-4 py-3 text-left text-sm font-medium text-[rgba(255,255,255,0.9)]">
                  Mängd
                ...
                <th className="px-4 py-3 text-center text-sm font-medium text-[rgba(255,255,255,0.9)]">
            ...
            <tbody>
              {ingredients.map((ingredient, index) => {
                ...
                return (
                  ...
                  >
                    <td className="px-4 py-3 text-[rgba(255,255,255,0.9)]">
                    ...
                    <td className="px-4 py-3">
                      <Input
                        ...
                        placeholder="2"
                        className="w-20 bg-[rgba(255,255,255,0.05)] border-[rgba(255,215,0,0.2)] text-white text-sm"
                      />
                    </td>
                    <td className="px-4 py-3">
                      <Select
                      ...
                      >
                        <SelectTrigger className="w-24 bg-[rgba(255,255,255,0.05)] border-[rgba(255,215,0,0.2)] text-white text-sm">
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                    ...
                    <td className="px-4 py-3 text-[rgba(255,255,255,0.7)] text-sm">
