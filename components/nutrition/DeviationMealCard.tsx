...
export function DeviationMealCard({
  deviationDate,
  components,
  totalNutrition,
  onDelete,
  ...
  return (
    <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl border-2 border-amber-200 overflow-hidden shadow-sm">
      {/* Header */}
      <div className="bg-gradient-to-r from-amber-100 to-orange-100 px-4 py-3 flex items-center justify-between border-b border-amber-200">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-amber-900">Kostavvikelse</h3>
        ...
        <div className="flex items-center gap-3">
          ...
          {onDelete && (
            <button
              onClick={onDelete}
              className="p-2 text-amber-500 hover:text-red-500 hover:bg-white/50 rounded-lg transition-colors"
            >
      ...
      <div className="p-4 space-y-2">
        {components.map((comp) => (
          ...
          >
            ...
            <div className="text-right">
              <p className="text-sm font-medium text-amber-700">{comp.kcal} kcal</p>
      ...
      {/* Footer with macros */}
      <div className="px-4 py-3 bg-white/40 border-t border-amber-100 flex justify-between items-center">
        <span className="text-sm font-medium text-amber-700">Totalt tillagt:</span>
