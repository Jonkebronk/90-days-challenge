            ...
            <div className="space-y-4">
              ...
              <div className={cn(
                ...
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center gap-2">
                    <Sparkles className={cn(
                      'h-5 w-5',
                      aiResult.confidence === 'high' ? 'text-amber-600' :
                      aiResult.confidence === 'medium' ? 'text-yellow-600' : 'text-red-600'
                    )} />
                    <span className={cn(
                      'font-semibold',
                      aiResult.confidence === 'high' ? 'text-amber-800' :
                ...
                {aiResult.reasoning && (
                  <p className={cn(
                    'text-sm',
                    aiResult.confidence === 'high' ? 'text-amber-700' :
                    aiResult.confidence === 'medium' ? 'text-yellow-700' : 'text-red-700'
                  )}>
                    {aiResult.reasoning}
                  </p>
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="flex-1 py-2 px-4 rounded-lg border border-amber-200 text-amber-600 text-sm font-medium hover:bg-amber-50 transition-colors"
                >
                  Korrigera manuellt
                </button>
              </div>
